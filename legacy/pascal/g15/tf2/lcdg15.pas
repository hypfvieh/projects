...
type TLcdG15 = class(TComponent)
  ...
  public
   ...
   constructor Create(ApplicationName:string;isPersistent:Bool;isAutostartable:Bool;SupportConfigure:boolean = false); reintroduce;
...
constructor TLcdG15.Create(ApplicationName:string;isPersistent:Bool;isAutostartable:Bool;SupportConfigure:boolean = false);
